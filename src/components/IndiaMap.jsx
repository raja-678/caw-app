...
export default function IndiaMap({ metric = 'crime', onStateClick }) {
    ...
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      {tooltip && (
        <div style={{
          ...
          fontSize: 13, boxShadow: '0 4px 12px rgba(0,0,0,0.08)', zIndex: 10, minWidth: 160
        }}>
          <div style={{ fontWeight: 500, marginBottom: 4 }}>{tooltip.state}</div>
          <div style={{ color: '#666', fontSize: 12 }}>{tooltip.label}</div>
