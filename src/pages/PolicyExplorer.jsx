...
const years = ['All', ...new Set(policies.map(p => p.year)).values()].sort()
    ...
    <div>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-secondary)' }}>
          Browse all 45 national policies and interventions for women's safety · 2013–2023
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap' }}>
        <input
          placeholder="Search policies or ministry..."
          value={search}
        ...
        <button
          onClick={() => { setSearch(''); setCategory('All'); setYear('All'); setType('All') }}
          style={{
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
                  ...
                  <div style={{
                    ...
                    background: c.bg, padding: '4px 10px', borderRadius: 'var(--radius-md)',
                    flexShrink: 0
                  }}>{p.year}</div>
                </div>
              </div>
        ...
        {selected && (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--text)', flex: 1, lineHeight: 1.4, paddingRight: 12 }}>
                {selected.name}
              </div>
              <button
